...
## [v4.1.15](https://github.com/agusmgarcia/react-core/tree/v4.1.15)

> April 16, 2025

- prevent fails when no git repository found

## [v4.1.14](https://github.com/agusmgarcia/react-core/tree/v4.1.14)

> April 12, 2025

- **createServerSlice**: reset error and loading on data set

## [v4.1.13](https://github.com/agusmgarcia/react-core/tree/v4.1.13)
...
## [v4.1.8](https://github.com/agusmgarcia/react-core/tree/v4.1.8)
